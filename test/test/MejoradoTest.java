...
public class MejoradoTest {
	...
	public void queEvalueBienPolinomioGrado20(){
		...
		System.out.println("[PolinomioEvaluarMejoradaGrado20: " + tiempo + " ns");
	}
	...
	public void queEvaluePolinomioGrado50() {
		...
		long tiempo = System.nanoTime()- start;
		System.out.println("[PolinomioEvaluarMejoradaGrado50: " + tiempo + " ns");		
	}
	...
	public void queEvaluePolinomioGrado100() {
		...
		long tiempo = System.nanoTime() - start;
		System.out.println("[PolinomioEvaluarMejoradaGrado100: " + tiempo + " ns");		
	}
	...
	public void queEvaluePolinomioGrado1000() {
		...
		long start = System.nanoTime();
		Assert.assertTrue(polinomioTest.evaluarMejorada(1) == 1001);		
		long tiempo = System.nanoTime() - start;
		System.out.println("[PolinomioEvaluarMejoradaGrado1000: " + tiempo + " ns");		
	}
	...
	public void queEvaluePolinomioGrado10000() {
		...
		long start = System.nanoTime();
		Assert.assertTrue(polinomioTest.evaluarMejorada(1) == 10001);		
		long tiempo = System.nanoTime() - start;
		System.out.println("[PolinomioEvaluarMejoradaGrado10000: " + tiempo + " ns");		
	}
	...
	public void queEvalueBienBinomioGrado20(){
		...
		long start = System.nanoTime();		
		Assert.assertTrue(binomioTest.evaluarMejorada(1)==1048576);		
		long tiempo = System.nanoTime() - start;
		System.out.println("[BinomioevaluarMejoradaGrado20: " + tiempo + " ns");
	}	
	...
	public void queEvalueBienBinomioGrado50(){
		...
		long start = System.nanoTime();
		Assert.assertTrue(binomioTest.evaluarMejorada(1)==637621500.21404958690340780691486);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarMejoradaGrado50: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado100(){
		...
		long start = System.nanoTime();
		Assert.assertTrue(binomioTest.evaluarMejorada(1)==406561177535215237.39727970756704);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarMejoradaGrado100: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado1000(){
		...
		long start = System.nanoTime();
		//Assert.assertTrue(binomioTest.evaluarMejorada(1)==406561177535215237.39727970756704);
		binomioTest.evaluarMejorada(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarMejoradaGrado1000: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado10000(){
		...
		binomioTest.evaluarMejorada(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarMejoradaGrado10000: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado20ConDesarrolloDePolinomio(){
		...
		Assert.assertTrue(binomioTest.evaluarMejoradaConDesarrollo(1)==resultado);		
		long tiempo = System.nanoTime() - start;
		System.out.println("[BinomioEvaluarMejoradaGrado20ConDesarrollo: " + tiempo + " ns");
	}	
	...
	public void queEvalueBienBinomioGrado50ConDesarrolloDePolinomio(){
		BinomioNewton binomioTest = new BinomioNewton(50,1,0.5);
		long start = System.nanoTime();
		binomioTest.evaluarMejoradaConDesarrollo(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarMejoradaGrado50ConDesarrollo: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado100ConDesarrolloDePolinomio(){
		...
		binomioTest.evaluarMejoradaConDesarrollo(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarMejoradaGrado100ConDesarrollo: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado1000ConDesarrolloDePolinomio(){
		...
		binomioTest.evaluarMejoradaConDesarrollo(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarMejoradaGrado1000ConDesarrollo: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado10000ConDesarrolloDePolinomio(){
		...
		binomioTest.evaluarMejoradaConDesarrollo(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarMejoradaGrado10000ConDesarrollo: " + tiempo + " ns");
	}
}
