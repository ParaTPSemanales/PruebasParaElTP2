...
public class ProgDinTest {
	...
	public void queEvalueBienPolinomioGrado20(){
		...
		System.out.println("[PolinomioEvaluarProgDinamicaGrado20: " + tiempo + " ns");
	}
	...
	public void queEvaluePolinomioGrado1000() {
		...
		long start = System.nanoTime();
		Assert.assertTrue(polinomioTest.evaluarProgDinamica(1) == 1001);		
		long tiempo = System.nanoTime() - start;
		System.out.println("[PolinomioEvaluarProgDinamicaGrado1000: " + tiempo + " ns");		
	}
	...
	public void queEvaluePolinomioGrado10000() {
		...
		long start = System.nanoTime();
		Assert.assertTrue(polinomioTest.evaluarProgDinamica(1) == 10001);		
		long tiempo = System.nanoTime() - start;
		System.out.println("[PolinomioEvaluarProgDinamicaGrado10000: " + tiempo + " ns");		
	}
	...
	public void queEvalueBienBinomioGrado20(){
		...
		long tiempo = System.nanoTime() - start;
		System.out.println("[BinomioevaluarProgDinamicaGrado20: " + tiempo + " ns");
	}	
	...
	public void queEvalueBienBinomioGrado50(){
		...
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarProgDinamicaGrado50: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado100(){
		...
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarProgDinamicaGrado100: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado1000(){
		...
		long start = System.nanoTime();
		//Assert.assertTrue(binomioTest.evaluarProgDinamica(1)==406561177535215237.39727970756704);
		binomioTest.evaluarProgDinamica(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarProgDinamicaGrado1000: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado10000(){
		...
		binomioTest.evaluarProgDinamica(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarProgDinamicaGrado10000: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado20ConDesarrolloDePolinomio(){
		...
		Assert.assertTrue(binomioTest.evaluarProgDinamicaConDesarrollo(1)==resultado);		
		long tiempo = System.nanoTime() - start;
		System.out.println("[BinomioEvaluarProgDinamicaGrado20ConDesarrollo: " + tiempo + " ns");
	}	
	...
	public void queEvalueBienBinomioGrado50ConDesarrolloDePolinomio(){
		BinomioNewton binomioTest = new BinomioNewton(50,1,0.5);
		long start = System.nanoTime();
		binomioTest.evaluarProgDinamicaConDesarrollo(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarProgDinamicaGrado50ConDesarrollo: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado100ConDesarrolloDePolinomio(){
		...
		binomioTest.evaluarProgDinamicaConDesarrollo(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarProgDinamicaGrado100ConDesarrollo: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado1000ConDesarrolloDePolinomio(){
		...
		binomioTest.evaluarProgDinamicaConDesarrollo(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarProgDinamicaGrado1000ConDesarrollo: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado10000ConDesarrolloDePolinomio(){
		...
		binomioTest.evaluarProgDinamicaConDesarrollo(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarProgDinamicaGrado10000ConDesarrollo: " + tiempo + " ns");
	}
}
