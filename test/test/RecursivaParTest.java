...
public class RecursivaParTest {
	...
	public void queEvalueBienPolinomioGrado20(){
		...
		System.out.println("[PolinomioEvaluarRecursivaParGrado20: " + tiempo + " ns");
	}
	...
	public void queEvaluePolinomioGrado50() {
		...
		long tiempo = System.nanoTime()- start;
		System.out.println("[PolinomioEvaluarRecursivaParGrado50: " + tiempo + " ns");		
	}
	...
	public void queEvaluePolinomioGrado100() {
		...
		long tiempo = System.nanoTime() - start;
		System.out.println("[PolinomioEvaluarRecursivaParGrado100: " + tiempo + " ns");		
	}
	...
	public void queEvaluePolinomioGrado1000() {
		...
		long start = System.nanoTime();
		Assert.assertTrue(polinomioTest.evaluarRecursivaPar(1) == 1001);		
		long tiempo = System.nanoTime() - start;
		System.out.println("[PolinomioEvaluarRecursivaParGrado1000: " + tiempo + " ns");		
	}
	...
	public void queEvaluePolinomioGrado10000() {
		...
		long start = System.nanoTime();
		Assert.assertTrue(polinomioTest.evaluarRecursivaPar(1) == 10001);		
		long tiempo = System.nanoTime() - start;
		System.out.println("[PolinomioEvaluarRecursivaParGrado10000: " + tiempo + " ns");		
	}
	...
	public void queEvalueBienBinomioGrado20(){
		...
		long start = System.nanoTime();		
		Assert.assertTrue(binomioTest.evaluarRecursivaPar(1)==1048576);		
		long tiempo = System.nanoTime() - start;
		System.out.println("[BinomioevaluarRecursivaParGrado20: " + tiempo + " ns");
	}	
	...
	public void queEvalueBienBinomioGrado50(){
		...
		long start = System.nanoTime();
		Assert.assertTrue(binomioTest.evaluarRecursivaPar(1)==637621500.21404958690340780691486);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarRecursivaParGrado50: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado100(){
		...
		long start = System.nanoTime();
		Assert.assertTrue(binomioTest.evaluarRecursivaPar(1)==406561177535215237.39727970756704);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarRecursivaParGrado100: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado1000(){
		...
		long start = System.nanoTime();
		//Assert.assertTrue(binomioTest.evaluarRecursivaPar(1)==406561177535215237.39727970756704);
		binomioTest.evaluarRecursivaPar(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarRecursivaParGrado1000: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado10000(){
		...
		binomioTest.evaluarRecursivaPar(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarRecursivaParGrado10000: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado20ConDesarrolloDePolinomio(){
		...
		Assert.assertTrue(binomioTest.evaluarRecursivaParConDesarrollo(1)==resultado);		
		long tiempo = System.nanoTime() - start;
		System.out.println("[BinomioEvaluarRecursivaParGrado20ConDesarrollo: " + tiempo + " ns");
	}	
	...
	public void queEvalueBienBinomioGrado50ConDesarrolloDePolinomio(){
		BinomioNewton binomioTest = new BinomioNewton(50,1,0.5);
		long start = System.nanoTime();
		binomioTest.evaluarRecursivaParConDesarrollo(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarRecursivaParGrado50ConDesarrollo: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado100ConDesarrolloDePolinomio(){
		...
		binomioTest.evaluarRecursivaParConDesarrollo(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarRecursivaParGrado100ConDesarrollo: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado1000ConDesarrolloDePolinomio(){
		...
		binomioTest.evaluarRecursivaParConDesarrollo(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarRecursivaParGrado1000ConDesarrollo: " + tiempo + " ns");
	}
	...
	public void queEvalueBienBinomioGrado10000ConDesarrolloDePolinomio(){
		...
		binomioTest.evaluarRecursivaParConDesarrollo(1);
		long tiempo = System.nanoTime() - start; 
		System.out.println("[BinomioEvaluarRecursivaParGrado10000ConDesarrollo: " + tiempo + " ns");
	}
}
